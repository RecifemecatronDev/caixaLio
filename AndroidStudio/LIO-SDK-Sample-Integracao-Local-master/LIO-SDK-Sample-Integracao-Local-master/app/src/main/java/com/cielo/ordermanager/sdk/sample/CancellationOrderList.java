...
public class CancellationOrderList extends AppCompatActivity {
    ...
    private void configSDK() {
        Credentials credentials = new Credentials( "G8lcvrxEdK045SsxiazLHbiVagCVfMeQb7le2XGLBKq8eUnLGe/ Vn2EbH8IgJSHN8ZlcD4iXTYR5sN0WLEppv9kHGoCr1IOr43rOL", "hEUjxMkLkDijYS1s9Zr7ypxHHIadHZRX1pp8KjZn17SRxI3n8e");
